!function(t) {
    ...
    function d(t) {
        t.touches ? (x.x = t.touches[0].pageX,
        x.y = t.touches[0].pageY) : (x.x = t.clientX,
        x.y = t.clientY),
        t.preventDefault()
    }
    function u(t) {
        1 == t.touches.length && (x.x = t.touches[0].pageX,
    ...
    function p() {
        ...
        y.ctx.drawImage(v, Math.round(y.width / 2 - v.width / 4), Math.round(y.height / 2 - v.height / 4), v.width / 2, v.height / 2),
    ...
    t.onload = function() {
        if (f = document.getElementById("canvas").getContext("2d"),
        f.stats = new Stats,
        f.running = !0,
        f.frame = 1,
        v = new Image,
        ...
        t.DEBUG) {
            var n = new dat.GUI;
            n.add(E, "trails", 1, 30).onChange(a),
            n.add(E, "size", 25, 75).onFinishChange(a),
            n.add(E, "friction", .45, .55).onFinishChange(a),
            n.add(E, "dampening", .01, .4).onFinishChange(a),
            n.add(E, "tension", .95, .999).onFinishChange(a),
            document.body.appendChild(f.stats.domElement)
        }
    }
}(window);